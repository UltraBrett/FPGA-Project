...
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\xst -intstyle ise -ifn "template.xst" -ofn "template.syr"
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\ngdbuild -intstyle ise -dd _ngo -nt timestamp -uc template.ucf -p xc6slx45-csg324-3 "template.ngc" template.ngd  
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\map -intstyle ise -p xc6slx45-csg324-3 -w -logic_opt off -ol high -t 1 -xt 0 -register_duplication off -r 4 -global_opt off -mt off -ir off -pr off -lc off -power off -o template_map.ncd template.ngd template.pcf 
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\par -w -intstyle ise -ol high -mt off template_map.ncd template.ncd template.pcf 
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\trce -intstyle ise -v 3 -s 3 -n 3 -fastpaths -xml template.twx template.ncd -o template.twr template.pcf -ucf template.ucf 
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\bitgen -intstyle ise -f template.ut template.ncd 
...
echo assignfile -p 1 -file template.bit >> commands.cmd
