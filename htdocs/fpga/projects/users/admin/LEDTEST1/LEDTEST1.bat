...
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\xst -intstyle ise -ifn "LEDTEST1.xst" -ofn "LEDTEST1.syr"
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\ngdbuild -intstyle ise -dd _ngo -nt timestamp -uc LEDTEST1.ucf -p xc6slx45-csg324-3 "LEDTEST1.ngc" LEDTEST1.ngd  
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\map -intstyle ise -p xc6slx45-csg324-3 -w -logic_opt off -ol high -t 1 -xt 0 -register_duplication off -r 4 -global_opt off -mt off -ir off -pr off -lc off -power off -o LEDTEST1_map.ncd LEDTEST1.ngd LEDTEST1.pcf 
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\par -w -intstyle ise -ol high -mt off LEDTEST1_map.ncd LEDTEST1.ncd LEDTEST1.pcf 
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\trce -intstyle ise -v 3 -s 3 -n 3 -fastpaths -xml LEDTEST1.twx LEDTEST1.ncd -o LEDTEST1.twr LEDTEST1.pcf -ucf LEDTEST1.ucf 
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\bitgen -intstyle ise -f LEDTEST1.ut LEDTEST1.ncd 
...
echo assignfile -p 1 -file LEDTEST1.bit >> commands.cmd
