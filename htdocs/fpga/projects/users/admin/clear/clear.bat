...
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\xst -intstyle ise -ifn "clear.xst" -ofn "clear.syr"
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\ngdbuild -intstyle ise -dd _ngo -nt timestamp -uc clear.ucf -p xc6slx45-csg324-3 "clear.ngc" clear.ngd  
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\map -intstyle ise -p xc6slx45-csg324-3 -w -logic_opt off -ol high -t 1 -xt 0 -register_duplication off -r 4 -global_opt off -mt off -ir off -pr off -lc off -power off -o clear_map.ncd clear.ngd clear.pcf 
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\par -w -intstyle ise -ol high -mt off clear_map.ncd clear.ncd clear.pcf 
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\trce -intstyle ise -v 3 -s 3 -n 3 -fastpaths -xml clear.twx clear.ncd -o clear.twr clear.pcf -ucf clear.ucf 
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\bitgen -intstyle ise -f clear.ut clear.ncd 
...
echo assignfile -p 1 -file clear.bit >> commands.cmd
