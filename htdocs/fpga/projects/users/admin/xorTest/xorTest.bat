...
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\xst -intstyle ise -ifn "xorTest.xst" -ofn "xorTest.syr"
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\ngdbuild -intstyle ise -dd _ngo -nt timestamp -uc xorTest.ucf -p xc6slx45-csg324-3 "xorTest.ngc" xorTest.ngd  
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\map -intstyle ise -p xc6slx45-csg324-3 -w -logic_opt off -ol high -t 1 -xt 0 -register_duplication off -r 4 -global_opt off -mt off -ir off -pr off -lc off -power off -o xorTest_map.ncd xorTest.ngd xorTest.pcf 
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\par -w -intstyle ise -ol high -mt off xorTest_map.ncd xorTest.ncd xorTest.pcf 
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\trce -intstyle ise -v 3 -s 3 -n 3 -fastpaths -xml xorTest.twx xorTest.ncd -o xorTest.twr xorTest.pcf -ucf xorTest.ucf 
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\bitgen -intstyle ise -f xorTest.ut xorTest.ncd 
...
echo assignfile -p 1 -file xorTest.bit >> commands.cmd
