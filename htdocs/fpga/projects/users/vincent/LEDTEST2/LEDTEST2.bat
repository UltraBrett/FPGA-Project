...
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\xst -intstyle ise -ifn "LEDTEST2.xst" -ofn "LEDTEST2.syr"
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\ngdbuild -intstyle ise -dd _ngo -nt timestamp -uc LEDTEST2.ucf -p xc6slx45-csg324-3 "LEDTEST2.ngc" LEDTEST2.ngd  
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\map -intstyle ise -p xc6slx45-csg324-3 -w -logic_opt off -ol high -t 1 -xt 0 -register_duplication off -r 4 -global_opt off -mt off -ir off -pr off -lc off -power off -o LEDTEST2_map.ncd LEDTEST2.ngd LEDTEST2.pcf 
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\par -w -intstyle ise -ol high -mt off LEDTEST2_map.ncd LEDTEST2.ncd LEDTEST2.pcf 
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\trce -intstyle ise -v 3 -s 3 -n 3 -fastpaths -xml LEDTEST2.twx LEDTEST2.ncd -o LEDTEST2.twr LEDTEST2.pcf -ucf LEDTEST2.ucf 
C:\Xilinx\13.3\ISE_DS\ISE\bin\nt\bitgen -intstyle ise -f LEDTEST2.ut LEDTEST2.ncd 
...
echo assignfile -p 1 -file LEDTEST2.bit >> commands.cmd
